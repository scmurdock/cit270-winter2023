...
https.createServer(
    {
        key:fs.readFileSync('/etc/letsencrypt/live/seanmurdock.cit270.com/privkey.pem'),
        cert:fs.readFileSync('/etc/letsencrypt/live/seanmurdock.cit270.com/cert.pem'),
        ca:fs.readFileSync('/etc/letsencrypt/live/seanmurdock.cit270.com/fullchain.pem')
    },
    app
).listen(port, ()=>{
    redisClient.connect();
